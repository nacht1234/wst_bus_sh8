...
<head>
    ...
    <title>Passengers - Spark Driver</title>
...
<body class="bg-gray-200">
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white p-6 shadow-lg rounded-lg">
            ...
            <nav class="space-y-4">
                ...
                <a href="" class="block py-2 px-4 bg-gray-300 rounded-md">Passengers</a>
            </nav>
        ...
        <div class="flex-1 flex flex-col items-center justify-center bg-gradient-to-r from-blue-400 to-blue-600 text-white p-10 rounded-lg">
            ...
            <div class="mt-10 bg-white p-6 rounded-lg shadow-md text-black w-full max-w-3xl">
                <h2 class="text-2xl font-semibold mb-4">Passengers</h2>

                <!-- Passengers Table -->
                <table class="w-full border-collapse text-left">
                    <thead>
                        <tr class="border-b">
                            <th class="py-2 px-4">Passengers Name</th>
                            <th class="py-2 px-4">Seat Number</th>
                            <th class="py-2 px-4">Ticket Type</th>
                        </tr>
                    </thead>
    ...
    <script>
        ...
        // Function to populate passengers table
        function populateTable(data) {
            ...
            data.forEach(item => {
                let row = `<tr class="border-b">
                    ...
                    <td class="py-2 px-4 font-bold">${item.seat}</td>
